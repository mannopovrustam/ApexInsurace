                    ...
                    <div class="card-body">
                        ...
                        <table class="table single-contract">
                            ...
                            <tr>
                                ...
                                <td class="text-warning"><b>{{ number_format(($data->amount - $data->amount_paid),2,"."," ") }}</b>
                                </td>
                            </tr>
                            <tr>
                                <th>Ҳолати</th>
                                    ...
                                    <form id="petition_{{ $petition->id }}">
                                        ...
                                        <div class="d-flex align-items-end justify-content-between">
                                            <div class="form-group" style="width: 50%;">
                                                ...
                                                <select class="form-select" name="template_id" id="petition-{{$petition->id}}">
                                                    @foreach(\App\Models\DocTemplate::all() as $d)
                                                        <option value="{{$d->id}}" @selected($d == $petition->type)>{{$d->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>

                                            <a href="{{ asset($petition->file) }}" download class="btn btn-success">Download</a>
                                            <button type="button" onclick="updatePetition('petition_{{ $petition->id }}')" class="btn btn-primary">Сақлаш</button>
                            ...
                            <div class="col-md-6">
                                <form id="petitions-form" method="post">
                                    ...
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" onclick="savePetition()" class="btn btn-primary">Сақлаш</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <form id="tax_expense">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6"><input type="text" name="tax" id="tax"
                                                                         class="form-control priceInput" placeholder="DAVLAT BOJ"
                                                                         value="{{ $data->tax }}"></div>
                                    ...
                                    @forelse($data->hybrids as $hybrid)
                                        <tr>
                                            <td>
                                                ...
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-{{ \App\Models\Contract\ContractHybrid::STATUS_COLOR[(int)$hybrid->status] }} waves-effect">{{ \App\Models\Contract\ContractHybrid::STATUS[(int)$hybrid->status] }}</button>
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item cursor-pointer btn btn-primary" onclick="printUID('{{ $hybrid->uid }}', true)">Чек</a>
                                                        <a class="dropdown-item cursor-pointer btn btn-primary" onclick="printUID('{{ $hybrid->uid }}', false)">Чексиз</a>
                                                    </div>
                                                </div>
                                            </td>
                                    ...
                                    @foreach($data->sms as $sms)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="text-muted text-decoration-underline" style="float: right" data-bs-toggle="modal"
                                                        data-bs-target="#edit{{ $sms->id }}">Кўпроқ</button>
                            ...
                            <div class="card-body">
                                <form id="judge_information">
                                    <table class="table single-contract">
                                        ...
                                        <tr>
                                            <th>Суд</th>
                                            <input type="hidden" class="form-control" name="judge_id" value="{{ $judge->id }}">
                                            <td>{{ $judge->name }}</td>
                                        </tr>
                                        <tr>
                                            <th>Иш №</th>
                                            <td><input type="text" name="work_number" class="form-control" value="{{ $data->judge?->work_number }}"></td>
                                        </tr>
                                        <tr>
                                            <th>Натижа</th>
                                            <td><input type="text" name="result" class="form-control" value="{{ $data->judge?->result }}"></td>
                                        </tr>
                                        <tr>
                                            <th>Изоҳ</th>
                                            <td><input type="text" name="note" class="form-control" value="{{ $data->judge?->note }}"></td>
                                        </tr>
                                        <tr style="text-align: right">
                                            <td></td>
                                            <td><button type="button" class="btn btn-primary" onclick="saveJudgeInfo()">Сақлаш</button></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </form>
                            ...
                            <div class="card-body">
                                <form id="mib_information">
                                    <table class="table single-contract">
                                        ...
                                        <tr>
                                            <th>МИБ</th>
                                            <td><input type="text" name="name" class="form-control" value="{{ $data->mib?->name }}"></td>
                                        </tr>
                                        <tr>
                                            <th>Ижро&nbsp;№</th>
                                            <td><input type="text" name="work_number" class="form-control" value="{{ $data->mib?->work_number }}"></td>
                                        </tr>
                                        <tr>
                                            <th>Натижа</th>
                                            <td><input type="text" name="result" class="form-control" value="{{ $data->mib?->result }}"></td>
                                        </tr>
                                        <tr>
                                            <th>Изоҳ</th>
                                            <td><input type="text" name="note" class="form-control" value="{{ $data->mib?->note }}"></td>
                                        </tr>
                                        <tr style="text-align: right">
                                            <td></td>
                                            <td><button type="button" class="btn btn-primary" onclick="saveMibInfo()">Сақлаш</button></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </form>
                            ...
                            <div class="card-body">
                                <form id="sms-manual-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sms_phone" id="sms_phone" class="form-control" required placeholder="998977820809">
                                    </div>
                                    <div class="form-group">
